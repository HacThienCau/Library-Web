...
public class BookService {
    ...
    // List<BorrowCard> recentBorrows =
    // borrowCardRepo.findTop5ByUserIdOrderByBorrowDateDesc(userId);
    ...
    // // 6. Lọc sách chưa mượn, tên hoặc tác giả chứa keyword, trả về tối đa 10
    // quyển
    // return bookRepo.findAll().stream()
    ...
    public List<Book> getPersonalizedSuggestions(String userId, List<String> keywords) {
        ...
        // 3. Lấy thông tin sách đã mượn
        List<Book> borrowedBooks = bookRepo.findAllById(borrowedBookIds);
