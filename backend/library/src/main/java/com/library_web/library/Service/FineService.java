...
public class FineService {
    ...
    public Fine addFine(Fine fine){
        ...
        if (savedFine.getNoiDung().toString().equals("Làm mất sách")){
            ...
            .orElseThrow(() -> new RuntimeException("Không tìm thấy sách con với id: " + savedFine.getCardId()));
    ...
    public Map<String, Object> getById(String id){
        Fine fine = fineRepo.findById(id).orElseThrow(() -> new RuntimeException("Không tìm thấy phiếu phạt với id: " + id));
        User user = userRepo.findById(fine.getUserId()).orElseThrow(() -> new RuntimeException("Không tìm thấy người dùng"));
        Object cardId;
