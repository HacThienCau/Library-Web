...
export const Header = () => {
  ...
  const fetchCart = async () => {
    try {
      const response = await fetch(`https://library-backend-ydnf.onrender.com/carts/user/${userId}`);
      if (response.ok) {
  ...
  try {
    const response = await fetch(`https://library-backend-ydnf.onrender.com/notification/${userId}`);
    if (response.ok) {
