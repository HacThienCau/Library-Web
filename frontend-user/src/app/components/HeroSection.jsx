...
export function HeroSection() {
  ...
  useEffect(() => {
    ...
    const fetchBooks = async () => {
      try {
        const response = await axios.get("https://library-backend-ydnf.onrender.com/books"); // đổi thành URL thật
    ...
    const fetchNewBooks = async () => {
      try {
        const res = await axios.get("https://library-backend-ydnf.onrender.com/books/newest");
    ...
    const fetchPopularBooks = async () => {
      try {
        const res = await axios.get(
          "https://library-backend-ydnf.onrender.com/books/most-borrowed"
        );
    ...
    const fetchLiteratureBooks = async () => {
      try {
        const res = await axios.get(
          "https://library-backend-ydnf.onrender.com/books/categories/parent/Văn%20học"
        );
    ...
    const fetchForeignBooks = async () => {
      try {
        const res = await axios.get(
          "https://library-backend-ydnf.onrender.com/books/categories/parent/Ngoại%20ngữ"
        );
    ...
    const fetchEconomicsBooks = async () => {
      try {
        const res = await axios.get(
          "https://library-backend-ydnf.onrender.com/books/categories/parent/Kinh%20tế"
        );
    ...
    fetchEconomicsBooks();
      ...
      try {
        ...
        const response = await axios.post("https://library-backend-ydnf.onrender.com/suggest", {
          userId: userId,
          keywords: keywords,
        });
        // console.log("Dữ liệu sách:", response.data);
