  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col flex-1 shrink self-end basis-0">
        ...
        <h3 className="flex-1 shrink gap-2.5 self-stretch mt-2 w-full text-[1.125rem] font-medium text-black line-clamp-1">
          {title}
        </h3>
        <p className="flex-1 shrink gap-2.5 self-stretch mt-2 w-full text-base text-black line-clamp-1">
          Tác giả: {author}
        </p>
        <p className="flex-1 shrink gap-2.5 self-stretch mt-2 w-full text-base text-black line-clamp-1">
          NXB: {publisher}
